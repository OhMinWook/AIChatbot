...
export default function UsageDatePicker({
  ...
  const handleSearchClick = () => {
    ...
    router.push(
      `/admin/usage/embedding/${currentTab}/${currentFilter}?startDate=${startDateParam}&endDate=${endDateParam}`,
    );
  };
  ...
  const resetHandler = () => {
    ...
    router.push(
      `/admin/usage/embedding/${currentTab}/${currentFilter}?startDate=${formattedAllDay}&endDate=${formattedToday}`,
    );
  };

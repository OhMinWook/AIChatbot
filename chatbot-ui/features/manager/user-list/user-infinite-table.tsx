...
import { useUserList } from '@/components/hooks/infinite-scroll/use-search-list';
...
export default function UserInfiniteTable() {
  ...
  // state;
  const [flatData, setFlatData] = useState<UserListData[]>([]);

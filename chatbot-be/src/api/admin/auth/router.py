...
from src.api.admin.auth import service
...
async def sign_in(
    ...
    response.set_cookie(
        key=config.ADMIN_COOKIE_NAME, value=request.session[config.ADMIN_COOKIE_NAME], httponly=True,
